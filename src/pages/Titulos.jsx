    ...
    render() {
        return (
            <div className="row" >
                ...
                <div className="col-10 offset-1" style={{ marginBlockStart: '30px', marginBlockEnd: '30px', textAlign: 'center', backgroundColor:'lightgrey', border:'groove' }}>TOTAL: {this.state.sum}</div>
            </div>
        );
    }
}
